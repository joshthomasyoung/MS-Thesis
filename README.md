This project contains the imporant files for my MS Thesis and Python model. The Python model is structured to be adaptable for different locations. The files are described below:
